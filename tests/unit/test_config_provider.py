...
from ioc import ConfigurationProvider, Provider
from ioc.providers.configuration import ConfigurationOption, TypedConfigurationOption
...
class TestConfigurationProvider:
    ...
    def test_from_yaml_success(self):
        ...
        with patch("builtins.open", mock_open(read_data=yaml_content)):
            with patch("ioc.providers.configuration.yaml") as mock_yaml:
    ...
    def test_from_yaml_no_yaml_module_raises_error(self):
        # Arrange
        with patch("ioc.providers.configuration.yaml", None):
            # Act & Assert
            with pytest.raises(ProvideObjectError) as exc_info:
